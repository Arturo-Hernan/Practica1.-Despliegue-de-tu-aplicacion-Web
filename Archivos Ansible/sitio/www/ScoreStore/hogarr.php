...
<body background="White">
                ...
                <th>
                    <div align='right'>
                        <div id="menu-wrapper2">
                            <div align='center'><a href="hogar.php">Cerrar Sesion</a></div>
                        </div>
                    </div>
                </th>
            </tr>
    ...
    <article>
        <div id="article4">
            <font color="black" size="6px">Hogar</font>
    </article>
    </div id="article4">
    <article>
        <div id="article4">
    ...
    <div class="container-fluid" id="contenidoTabla">
        <table align="center" border="1px" style="width:auto; height:auto;">
            <?php
               ...
               $registros=mysqli_query($conexion,"select idTienda, idcategoria, DescripcionT, Link from tienda where idcategoria='3'") or die ("problemas en el select").mysqli_error($conexion);
