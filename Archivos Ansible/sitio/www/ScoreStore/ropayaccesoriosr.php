...
<head>
    ...
    <title>ScoreStore-RopayAccesorios</title>
...
<body background="White">
                ...
                <th>
                    <div align='right'>
                        <div id="menu-wrapper2">
                            <div align='center'><a href="ropayaccesorios.php">Cerrar Sesion</a></div>
                        </div>
                    </div>
                </th>
            </tr>
    ...
    <article>
        <div id="article7">
            <font color="black" size="6px">Ropa y Accesorios</font>
    </article>
    </div id="article7">
    <article>
        <div id="article4">
    ...
    <div class="container-fluid" id="contenidoTabla">
        <table align="center" border="1px" style="width:auto; height:auto;">
            <?php
               ...
               $registros=mysqli_query($conexion,"select idTienda, idcategoria, DescripcionT, Link from tienda where idcategoria='2'") or die ("problemas en el select").mysqli_error($conexion);
