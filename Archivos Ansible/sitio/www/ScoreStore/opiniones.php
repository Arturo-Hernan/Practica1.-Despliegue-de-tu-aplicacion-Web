                        ...
                        <div class="container-fluid" id="contenidoTabla">
                            <div class="ctn-form">
                                <?php
									$idTienda = $_GET['idTienda'];
									$conexion=mysqli_connect("localhost","root","admin","scorestore")or die ("problemas en la conexion");
									$registros=mysqli_query($conexion,"select urlT, Link from tienda where idTienda='" . $idTienda . "'") or die ("problemas en el select").mysqli_error($conexion);
									...
									while($reg=mysqli_fetch_array($registros)){
										...
										echo "</tr>";
										echo "<tr>";
											echo "<td>","<a href='".$reg['urlT']."'>","<input type='submit2' value='Ir a tienda'>","</a>","</td>";
										echo "</tr>";
									}
									echo "</table>"
								?>
