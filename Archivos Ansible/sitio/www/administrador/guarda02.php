                ...
                <div id="article9">
                    <font color="white" size="5px">
                        <?php
                              ...
                              mysqli_query($conexion,"insert into tienda(idcategoria,urlT,DescripcionT,NombreT,Link) values('$_REQUEST[idcategoria]','$_REQUEST[urlT]','$_REQUEST[DescripcionT]','$_REQUEST[NombreT]','$_REQUEST[Link]')") or die("problemas en el select".mysqli_error());
                              mysqli_close($conexion);
                              echo "La Tienda ha sido dado de alta";
                         ?>
                    </font>
            </article>
            </div id="article9">
